...
TEST(BaggagePropagatorTest, ExtractAndInjectBaggage)
{
  ...
  nostd::string very_large_baggage_header =
      nostd::string(baggage::Baggage::kMaxKeyValueSize / 2 + 1, 'k') + "=" +
      nostd::string(baggage::Baggage::kMaxKeyValueSize / 2 + 1, 'v');

  std::map<nostd::string, nostd::string> baggages = {
