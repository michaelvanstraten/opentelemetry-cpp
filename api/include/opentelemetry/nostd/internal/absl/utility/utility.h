...
//     void Bar(int);
//   };
//   void user_function1(int, nostd::string);
//   void user_function2(std::unique_ptr<Foo>);
//   auto user_lambda = [](int, int) {};
//
//   int main()
//   {
//       std::tuple<int, nostd::string> tuple1(42, "bar");
//       // Invokes the first user function on int, nostd::string.
...
//   auto s = absl::make_from_tuple<nostd::string>(args);
//   assert(s == "hello");
//
